...
Despite being given 10 inputs of debatable quality and an admittedly very finnicky test env, a network with just 1 layer of 8 neurons is
...
effectively (ab)use physics, doing things like coasting through atmospheric drag!
